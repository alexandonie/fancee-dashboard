...
(function () {
  var Charts = (function () {
    ...
    var setGlobalOptions = function () {
      ...
      Chart.defaults.polarArea.scale.gridLines.color = colors.gray;
      Chart.defaults.polarArea.scale.angleLines.color = colors.gray;
  ...
  var filledLineChart = document.getElementById('filledLineChart');
  if (filledLineChart) {
    Charts.newChart(filledLineChart, {
      type: 'line',
      data: {
        ...
        datasets: [
          {
            ...
            pointBackgroundColor: Charts.colors.white,
            pointRadius: 5,
            pointHoverRadius: 5
          }
        ]
  ...
  var verticalBarChart = document.getElementById('verticalBarChart');
  if (verticalBarChart) {
    Charts.newChart(verticalBarChart, {
      type: 'bar',
      data: {
        ...
        datasets: [
          ...
          },
          {
            label: 'Cost',
            data: [10, 20, 30, 50],
            backgroundColor: Charts.colors.warningTransparent,
